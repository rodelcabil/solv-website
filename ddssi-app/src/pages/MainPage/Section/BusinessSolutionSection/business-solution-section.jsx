...
const BusinessSolutionSection = () => {
  return (
    <MainContainer id="solution">
      ...
      <br /><br /><br />
      <BodyContainer>
        <div data-aos="fade-up" className='flex items-stretch justify-center'>
        ...
        <div data-aos="fade-up" data-aos-delay="100" className='flex items-stretch justify-center'>
        ...
        <div data-aos="fade-up" data-aos-delay="200" className='flex items-stretch justify-center'>
        ...
        <div data-aos="fade-up" data-aos-delay="300" className='flex items-stretch justify-center'>
        ...
        <div data-aos="fade-up" data-aos-delay="500" className='flex items-stretch justify-center'>
