...
import { MainContainer, Banner, PlanContainer } from './solv24-styles'
    ...
    return (
        <>
            ...
            <MainContainer id="read-more">
                ...
                <PlanContainer col={4}>
                    <SubscriptionCard header="SOLV 24" title="Uno 24" price="₱4,125.00 monthly" color="#1595FF" description="Uno is our entry level variant of SOLV Business Solution. It includes software for 1 Headquarters with unlimited users, a stand alone software for 1 x single node/branch with unlimited users. 24 months installment." />
                    <SubscriptionCard header="SOLV 24" title="Solo 24" price="₱4,125.00 monthly" color="#D7B146" description="Solo 24 is our single log-in variant of SOLV Business Solution. It includes software for combined headquarters and branch with unlimited users, auto approval, 24 months installment." />
                    <SubscriptionCard header="SOLV 24" title="Duo 24" price="₱6,625.00 monthly" color="#5469AC" description="Duo is the ideal SOLV Business Solution variant for businesses with 2 branches. It includes software for 1 Headquarters with unlimited users, stand alone software for 2 x single nodes/branches with unlimited users. 24 months installment." />
                    <SubscriptionCard header="SOLV 24" title="POS 24" price="₱750.00 monthly" color="#AD4742" description="A convenient way to accurately record sales and keep track of how your business is doing. It also integrates with POS devices. POS is an add-on or stand alone point of sale software for a Single Node with unlimited users." />
                </PlanContainer>
                <br /><br />
                <div className="flex w-full m-auto max-w-[1500px] py-[30px]">
                ...
                <PlanContainer col={2}>
                    <SubscriptionCard header="SOLV 24" title="Accounting One 24" price="₱6,208.33 monthly" color="#D7B146" description="Accounting One is a stand-alone advance accounting system. It will simplify, digitize and automate your accounting processes and ensure accurate recording of your company's financial transactions into organized accounts." />
                    <SubscriptionCard header="SOLV 24" title="Accounting Connect 24" price="₱6,208.33 monthly" color="#5469AC" description="Accounting Connect is an add-on software that will add an integrated advance accounting module to your SOLV system. It will simplify, digitize and automate your accounting processes and ensure accurate recording of your company's financial transactions into organized accounts." />
                ...
                <PlanContainer col={3}>
                    <SubscriptionCard header="SOLV 24" title="Hr Solution Starter 24" price="₱2,875.00 monthly" color="#AD4742" description="Hr Solution Basic 24 is an add-on or stand alone software that will provide a complete solution for the Human Resources Department and expand the capabilities of your SOLV system. Hr Solution includes payroll, Human Resources Information System (HRIS) and timekeeping with geo tagging." />
                    <SubscriptionCard header="SOLV 24" title="Hr Solution Basic 24" price="₱4,125.00 monthly" color="#1595FF" description="Hr Solution Basic 24 is an add-on or stand alone software that will provide a complete solution for the Human Resources Department and expand the capabilities of your SOLV system. Hr Solution includes payroll, Human Resources Information System (HRIS) and timekeeping with geo tagging." />
                    <SubscriptionCard header="SOLV 24" title="Hr Solution Intermediate 24" price="₱7,041.67 monthly" color="#738A46" description="Hr Solution Intermediate 24 is an add-on or stand alone software that will provide a complete solution for the Human Resources Department and expand the capabilities of your SOLV system. Hr Solution includes payroll, Human Resources Information System (HRIS) and timekeeping with geo tagging." />
                </PlanContainer>
            </MainContainer>
