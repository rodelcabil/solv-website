    ...
    <MainContainer ref={ref} id="solution">
      ...
      <BodyContainer>
        <div data-aos="fade-up" data-aos-delay="100" className='flex w-[100%] items-stretch justify-center'>
          <BusinessSolutionCard className="items-stretch" title="SOLV 24" icon={SolvLogo} description="Ready to use set of full featured business solution software for any type and size of business at a price point and easy payment terms that cannot be ignored." link="/solution/solv-24" hasReadMore={true} toInquiry={false}/>
        </div>
        <div data-aos="fade-up" data-aos-delay="100" className='flex w-[100%] items-stretch justify-center'>
          <BusinessSolutionCard title="SOLV Sales and Inventory" icon={SoloBgImg} description="It is a web-based point-of-sales, inventory, customer management and reporting tool designed for small and medium Business (SMBs) who needs a direct and practical approach in recording and maintaining their business transactions." link="/solution/sales-and-inventory" hasReadMore={true} toInquiry={false}/>
        </div>
        <div data-aos="fade-up" data-aos-delay="100" className='flex w-[100%] items-stretch justify-center'>
          <BusinessSolutionCard title="SOLV Hr Solution" icon={HRSolution} description="End to end software solution for the Human Resources Department designed to improve delivery of service, efficiency and productivity. Hr Solution includes payroll, Human Resources Information System (HRIS) and system timekeeping with geo tagging." link="/solution/hr-solutions" hasReadMore={true} toInquiry={false}/>
        </div>
        <div data-aos="fade-up" data-aos-delay="100" className='flex w-[100%] items-stretch justify-center'>
          <BusinessSolutionCard title="SOLV Accounting" icon={Accounting} description="Simplified accounting system perfect for small and medium businesses. Manage your finances easily and have accurate reports at a press of a button." link="/solution/accounting" hasReadMore={true} toInquiry={false}/>
        </div>
        <div data-aos="fade-up" data-aos-delay="100" className='flex w-[100%] items-stretch justify-center'>
          <BusinessSolutionCard title="SOLV Add-ons" icon={AddOns} description="Building blocks that add features to your SOLV system. It allows you to expand and scale at your own pace instead of being forced to get a system with features you do not need." link="/solution/add-ons" hasReadMore={true} toInquiry={false}/>
        </div>
        <div data-aos="fade-up" data-aos-delay="200" className='flex w-[100%] items-stretch justify-center'>
          <BusinessSolutionCard title="SOLV Custom" icon={Custom} description="Our SOLV business solution software are already packed with features and functionality. We also do software customization to add unique processes for those who want it." link="/solution/custom" hasReadMore={true} toInquiry={false}/>
        </div>
        <div data-aos="fade-up" data-aos-delay="300" className='flex w-[100%] items-stretch justify-center'>
          <BusinessSolutionCard title="E-Commerce Platform" icon={ECommerce} description="Selling online is fast replacing brick and mortar stores. Our platform is ready for companies who want to take the leap and establish their online presence. Complete with back-end and payment facility for simple and easy operation." link="contact-page" hasReadMore={true} toInquiry={true}/>
        </div>
        ...
        <div data-aos="fade-up" data-aos-delay="500" className='flex w-[100%] items-stretch justify-center'>
          <BusinessSolutionCard title="Other Services" icon={OtherServices} description="We also provide cloud hosting solutions, other network related services and hardware i.e. servers, computers, VPN, biometrics devices and other computer related products." link="/contact-page" hasReadMore={true} toInquiry={true}/>
        </div>
